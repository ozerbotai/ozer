// Based on https://github.com/attestate/better-sqlite3-session-store/commit/f9856f1880dc84099fc173b714a10fdc7b513919
// @format
const noop = () => {};
...
module.exports = ({ Store }) => {
  class SqliteStore extends Store {
    ...
    startInterval() {
      this.intervalRemoverHandle = setInterval(
    ...
    close() {
      this.client.close();
      clearInterval(this.intervalRemoverHandle);
    }
  }
